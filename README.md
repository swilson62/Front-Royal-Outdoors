...
The Django application "frontroyaloutdoors" is to be my submission for the final "Capstone" project in the CS50W 2020 class. It is my adaptation of the `https://frontroyaloutdoors.com/` website. This website is owned by a friend of mine who runs a local river outfitting business. The pictures were used with permission of `frontroyaloutdoors.com`, and cannot be used without written permission. The web site allow users to reserve boats of various available types, for a given trip, on a given date.
